...
@section('body')
     ...
     <section id="hero" class="d-flex align-items-center">
        <div class="container position-relative text-center text-lg-start" data-aos="zoom-in" data-aos-delay="100">
          <div class="row">
            <div class="col-lg-8">
              <h1>Welcome to <span>Digital Printing</span></h1>
        ...
        <div class="container" data-aos="fade-up">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
              <p>Kami adalah tim yang berdedikasi tinggi di bidang digital printing, menghubungkan kreativitas dengan teknologi canggih untuk menghasilkan solusi cetak digital berkualitas tinggi. Sebagai pelopor di industri ini, kami telah mengukir jejak yang kuat dengan menggabungkan inovasi terkini dan layanan pelanggan yang unggul.</p>

              <h2>Visi Kami</h2>
              <p>Visi kami adalah menjadi mitra pilihan utama dalam segala kebutuhan cetak digital. Kami ingin memperluas batas-batas kreativitas melalui teknologi mutakhir, memberikan layanan yang tak tertandingi, dan berkontribusi dalam kesuksesan dan pertumbuhan bisnis setiap klien kami.</p>

              <h2>Misi Kami</h2>
              <ul>
                  <li>Inovasi Tanpa Henti</li>
                  <li>Kualitas Tak Terkompromi</li>
                  <li>Kolaborasi Aktif</li>
                  <li>Kepuasan Pelanggan Utama</li>
                  <li>Berkelanjutan dan Bertanggung Jawab</li>
              </ul>

              <h2>Layanan Kami</h2>
              <ul>
                  <li>Cetak Produk Promosi</li>
                  <li>Percetakan Kustom</li>
                  <li>Cetak Produk Seni</li>
                  <li>Cetak Pribadi</li>
              </ul>

              <p>Kami bangga menjadi bagian dari perjalanan kreatif Anda. Jadilah bagian dari revolusi digital printing bersama kami dan beri hidup pada ide-ide Anda dengan warna dan detail yang luar biasa.</p>
