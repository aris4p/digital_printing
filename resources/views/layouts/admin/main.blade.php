<!DOCTYPE html>
  ...
  <body>
                ...
                <li class="nav-item ms-auto navbar-dropdown dropdown-user dropdown ">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="{{ asset ('assets/admin_template/img/avatars/1.png') }}" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          <div class="flex-shrink-0 me-3">
                            <div class="avatar avatar-online">
                              <img src="assets/admin_template/img/avatars/1.png" alt class="w-px-40 h-auto rounded-circle" />
                            </div>
                          </div>
    ...
    <script src="{{ asset ('assets/admin_template/vendor/libs/jquery/jquery.js') }}"></script>
    <script src="{{ asset ('assets/admin_template/vendor/libs/popper/popper.js') }}"></script>
    <script src="{{ asset ('assets/admin_template/vendor/js/bootstrap.js') }}"></script>
    <script src="{{ asset ('assets/admin_template/vendor/libs/perfect-scrollbar/perfect-scrollbar.js') }}"></script>

    <script src="{{ asset ('assets/admin_template/vendor/js/menu.js') }}"></script>
    <!-- endbuild -->

    <!-- Vendors JS -->
    <script src="{{ asset ('assets/admin_template/vendor/libs/apex-charts/apexcharts.js') }}"></script>

    <!-- Main JS -->
    <script src="{{ asset ('assets/admin_template/js/main.js') }}"></script>

    <!-- Page JS -->
    <script src="{{ asset ('assets/admin_template/js/dashboards-analytics.js') }}"></script>
